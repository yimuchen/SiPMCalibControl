 ...
 * styling.js
 *
 * The function in this page is mainly aimed to help with miscellaneous styling
 * tasks that enhances the user experience, such as matching the text and slider
 * input values, css manipulations to ensure that the objects are displayed
 * properly. In addition to direct styling of the DOM elements, general
 * javascript snippets that are difficult to classify are also placed here.
 */
...
/**
 * Thin wrapper to call sync_text_to_range_by_id given a DOM event.
 */
...
/**
 * Thin wrapper to call sync_range_to_text_by_id given an DOM event.
 */
...
/**
 * For the chevron indicators used in the tab displays, ensure that the chvron
